package cn.project.demo.framework.web.log.filter;
...
public class ApiAccessLogFilter extends OncePerRequestFilter {
    ...
    private void createApiAccessLog(HttpServletRequest request, Date beginTime, Map<String, String> queryString, String requestBody, Exception ex) {
