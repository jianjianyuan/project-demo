package cn.project.demo.framework.web.swagger;
...
@ConditionalOnProperty(prefix = "project.swagger", value = "enable", matchIfMissing = true)
// 允许使用 swagger.enable=false 禁用 Swagger
@EnableConfigurationProperties(SwaggerProperties.class)
public class FrameworkSwaggerAutoConfiguration {
